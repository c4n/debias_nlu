...
{"psql":{
        ...
        "debiasing_method":"ps_lr_v2",
        "slurm_script": "job_weighted_bert_base_ps_v2.sub",
        "output_dir": "outputs_ps_bert_base_v2",
        "exp_remarks": "we include more vocabs for negation"}
,
  "dataset_reader": {
  ...
  "train_data_path": "/ist/users/canu/debias_nlu/data/nli/gam_fixed_lr_sample_weight.jsonl",
