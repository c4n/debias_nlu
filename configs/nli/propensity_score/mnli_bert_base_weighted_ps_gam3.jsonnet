...
{"psql":{
        "training_strategy":"cross_entroy+sample_weighting",
        "debiasing_method":"ps_lr_v3",
        "slurm_script": "job_weighted_bert_base_ps_v3.sub",
        "output_dir": "outputs_ps_bert_base_v3",
        "exp_remarks": "we include sentence length as a feature"}
,
  "dataset_reader": {
  ...
  "train_data_path": "/ist/users/canu/debias_nlu/data/nli/gam_fixed_v3_lr_sample_weight.jsonl",
