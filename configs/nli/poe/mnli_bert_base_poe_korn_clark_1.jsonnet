...

{
  ...
  "train_data_path": "/ist/users/canu/debias_nlu/data/nli/train_prob_korn_full_lr_overlapping_sample_weight_3class.jsonl",
  ...
  "model": {
    "type": "product_of_expert_basic_classifier",
    "text_field_embedder": {
      "token_embedders": {
        "tokens": {
          "type": "pretrained_transformer",
