...
@Model.register("distill_basic_classifier")
class DistillBasicClassifier(BasicClassifier):
    def __init__(
        self,
        vocab: Vocabulary,
    ...
    def forward(  # type: ignore
        self, tokens: TextFieldTensors, label: torch.IntTensor = None, distill_probs: Union[torch.Tensor, np.ndarray] = None
        ...
        if label is not None:
            ...
            if distill_probs is not None:
                ...
                loss = self._distill_loss(log_probs,distill_probs)
            else:
