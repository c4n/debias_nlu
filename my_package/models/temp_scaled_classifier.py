...
@Model.register("temp_scaled_basic_classifier")
class TempScaledBasicClassifier(BasicClassifier):
    def __init__(
        self,
        vocab: Vocabulary,
        ...
        **kwargs,
        ...
        self.temperature = pickle.load( open( pickled_temperature_path, "rb" ) )
